# -*- coding: utf-8 -*-
"""
Paragon Harvester - Python 2.7 compatibility gate.
...
def shipped_files():
    ...
    # service.py is optional: this add-on is a script with no background
    # half, and a file that was never meant to exist is not a problem.
    paths = [path for path in (os.path.join(ROOT, 'default.py'),
